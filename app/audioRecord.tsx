...
const ListenScreen = () => {
    ...
    const [allRecordings, setAllRecordings] = useState<{ sound: Audio.Sound, status: AVPlaybackStatusSuccess | AVPlaybackStatusError, getURI: string | null, date: string }[]>([]);
    ...
    const updateWaveform = async (status: any) => {
        ...
        <SafeAreaView style={styles.safeArea}>
            <LinearGradient colors={['#e8f5e9', '#c8e6c9']} style={styles.container}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <Link
                        href={{
                            pathname: '/audioRecording',
                            params: { recordings: JSON.stringify(allRecordings) }
                        }}
